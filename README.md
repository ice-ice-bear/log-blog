...
1. Extracts Chrome browsing history for the last 24 hours
2. Classifies each URL by type (YouTube, GitHub repo/PR/issue, docs, web page)
3. Shows you the classified list and asks for approval
4. Fetches enriched content — transcripts for YouTube, structured data for GitHub, full text for web pages
5. Writes a deep-dive technical blog post in your preferred language
6. Generates a cover image and publishes to your Hugo blog repo
...
- GitHub repo/PR/issue enrichment via `gh` CLI
